...
! function(e) {
    ...
    var t, n, i, r, o, a, s = "Close",
        ...
        w = function(e, n) {
            t.ev.triggerHandler("mfp" + e, n), t.st.callbacks && (e = e.charAt(0).toLowerCase() + e.slice(1), t.st.callbacks[e] && t.st.callbacks[e].apply(t, Array.isArray(n) ? n : [n]))
        },
        b = function(n) {
    ...
    v.prototype = {
        ...
        open: function(n) {
            ...
            w("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (y(c, function(e, t, n, i) {
                n.close_replaceWith = b(i.type)
            }), o += " mfp-close-btn-in") : t.wrap.append(b())), t.st.alignTop && (o += " mfp-align-top"), t.fixedContentPos ? t.wrap.css({
            ...
            return t.isIE7 && (h += " mfp-ie7"), h && t._addClassToMFP(h), t.updateItemHTML(), w("BuildControls"), e("html").css(g), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout(function() {
                t.content ? (t._addClassToMFP(f), t._setFocus()) : t.bgOverlay.addClass(f), i.on("focusin" + u, t._onFocusIn)
            }, 16), t.isOpen = !0, t.updateSize(m), w(p), n
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            if (w("BeforeChange", [t.currItem ? t.currItem.type : "", i]), t.currItem = n, !t.currTemplate[i]) {
                ...
                w("FirstMarkupParse", o), o ? t.currTemplate[i] = e(o) : t.currTemplate[i] = !0
            }
            r && r !== n.type && t.container.removeClass("mfp-" + r + "-holder");
            var a = t["get" + i.charAt(0).toUpperCase() + i.slice(1)](n, t.currTemplate[i]);
            t.appendContent(a, i), n.preloaded = !0, w(d, n), r = n.type, t.container.prepend(t.contentContainer), w("AfterChange")
        },
        ...
        updateStatus: function(e, i) {
            if (t.preloader) {
                ...
                w("UpdateStatus", r), e = r.status, i = r.text, t.st.allowHTMLInStatusIndicator ? t.preloader.html(i) : t.preloader.text(i), t.preloader.find("a").on("click", function(e) {
        ...
        _checkIfClose: function(n) {
            if (!e(n).closest("." + g).length) {
                ...
                if (i && r || !t.content || e(n).closest(".mfp-close").length || t.preloader && n === t.preloader[0]) return !0;
        ...
        _hasScrollBar: function(e) {
            return (t.isIE7 ? i.height() : document.body.scrollHeight) > (e || $.height())
        },
        _setFocus: function() {
        ...
        _parseMarkup: function(n, i, r) {
            var o;
            r.data && (i = e.extend(r.data, i)), w(c, [n, i, r]), e.each(i, function(i, r) {
                if (void 0 === r || !1 === r) return !0;
                if ((o = i.split("_")).length > 1) {
                    var a = n.find(u + "-" + o[0]);
                    if (a.length > 0) {
                        var s = o[1];
                        "replaceWith" === s ? a[0] !== r[0] && a.replaceWith(r) : "img" === s ? a.is("img") ? a.attr("src", r) : a.replaceWith(e("<img>").attr("src", r).attr("class", a.attr("class"))) : a.attr(o[1], r)
                    }
        ...
        if ("string" == typeof n) {
            if ("open" === n) {
                var r, o = h ? i.data("magnificPopup") : i[0].magnificPopup,
                    a = parseInt(arguments[1], 10) || 0;
                o.items ? r = o.items[a] : (r = i, o.delegate && (r = r.find(o.delegate)), r = r.eq(a)), t._openClick({
                    mfpEl: r
                }, i, o)
            } else t.isOpen && t[n].apply(t, Array.prototype.slice.call(arguments, 1))
        } else n = e.extend(!0, {}, n), h ? i.data("magnificPopup", n) : i[0].magnificPopup = n, t.addGroup(i, n);
        return i
    };
    var _, k, P, S = "inline",
        T = function() {
            ...
            getInline: function(n, i) {
                if (T(), n.src) {
                    ...
                    if (o.length) {
                        ...
                        a && a.tagName && (k || (k = C(_ = r.hiddenClass), _ = "mfp-" + _), P = o.after(k).detach().removeClass(_)), t.updateStatus("ready")
            ...
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, r, o) {
                        ...
                        w("ParseAjax", a), t.appendContent(e(a.data), z), n.finished = !0, O(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(f)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var n = t.st.image,
                    i = ".image";
                t.types.push("image"), y(p + i, function() {
                    "image" === t.currItem.type && n.cursor && e(document.body).addClass(n.cursor)
                }), y(s + i, function() {
                    n.cursor && e(document.body).removeClass(n.cursor), $.off("resize" + u)
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, B && clearInterval(B), e.isCheckingImgSize = !1, w("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
                ...
                var n = 0,
                    ...
                    r = function(o) {
                        B && clearInterval(B), B = setInterval(function() {
                            ...
                            n > 200 && clearInterval(B), 3 == ++n ? r(10) : 40 === n ? r(50) : 100 === n && r(500)
                        }, o)
                    };
                r(1)
            },
            getImage: function(n, i) {
                var r = 0,
                    ...
                    s = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, w("ImageLoadComplete")) : ++r < 200 ? setTimeout(s, 100) : a())
                    },
                    l = i.find(".mfp-img");
                if (l.length) {
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && t.supportsTransition) {
                    ...
                    y("BuildControls" + i, function() {
                        if (t._allowZoom()) {
                            if (clearTimeout(r), t.content.css("visibility", "hidden"), !(e = t._getItemToZoom())) {
                                p();
                                return
            ...
            _getOffset: function(n) {
                ...
                return (void 0 === L && (L = void 0 !== document.createElement("p").style.MozTransform), L) ? s["-moz-transform"] = s.transform = "translate(" + r.left + "px," + r.top + "px)" : (s.left = r.left, s.top = r.top), s
            }
        }
    });
    var A = "iframe",
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                n.langDir || (n.langDir = document.dir || "ltr"), o += " mfp-gallery", y(p + r, function() {
                    ...
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        "rtl" === n.langDir ? (i = n.tNext, r = n.tPrev, o = "next", a = "prev") : (i = n.tPrev, r = n.tNext, o = "prev", a = "next");
                        var i, r, o, a, s = n.arrowMarkup,
                            l = t.arrowLeft = e(s.replace(/%title%/gi, i).replace(/%action%/gi, o).replace(/%dir%/gi, "left")).addClass(g),
                            c = t.arrowRight = e(s.replace(/%title%/gi, r).replace(/%action%/gi, a).replace(/%dir%/gi, "right")).addClass(g);
                        "rtl" === n.langDir ? (t.arrowNext = l, t.arrowPrev = c) : (t.arrowNext = c, t.arrowPrev = l), l.on("click", function() {
